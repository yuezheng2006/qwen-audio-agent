...
const USER_CONFIG_TEMPLATE = [
  ...
  '# 后台由本地 Gateway 管理时使用 owned；外部托管进程才使用 external',
  ...
  '',
  '# DashScope 旧版音色复刻会从公网拉取浏览器录音样本。',
  '# 配置 HTTPS 隧道或反向代理后填写 Gateway 的公网根地址。',
  '# VOICE_SAMPLE_PUBLIC_BASE_URL=https://voice.example.com',
  '',
